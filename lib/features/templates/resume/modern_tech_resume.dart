        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                // Left Column (Skills, Education, Languages, Certifications) - 35%
                Expanded(
                  flex: 4,
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    cert,
                                    style: GoogleFonts.outfit(fontSize: 10, color: const Color(0xFF334155)),
                                  ),
                                ),
                              ],
                            ),
                      ...
                      if (resume.languages.isNotEmpty) ...[
                        ...
                        Text(
                          ...
                          style: GoogleFonts.outfit(fontSize: 10, color: const Color(0xFF475569)),
                        ),
                      ],
                    ],
                  ),
                ...
                Container(width: 1, height: 420, color: const Color(0xFFE2E8F0)),
                const SizedBox(width: 18),

                // Right Column (Summary, Experience, Projects) - 65%
                Expanded(
                  flex: 6,
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildSectionHeader(String title, Color color) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 2),
        Container(height: 1.5, width: 28, color: color),
      ],
    );
  }
